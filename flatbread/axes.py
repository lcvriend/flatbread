...
def resolve_axis(axis: Axis) -> int:
    """
    Resolve axis parameter to integer.

    Parameters
    ----------
    axis : int | str | None
        Axis specification:
        - 0 or 'index': index axis
        - 1 or 'columns': columns axis
        - 2 or 'both': both axes

    Returns
    -------
    int
        Resolved axis as integer
    """
    match axis:
        case 0 | 'index' | 'rows' | None:
            return 0
        case 1 | 'columns':
            return 1
        case 2 | 'both':
